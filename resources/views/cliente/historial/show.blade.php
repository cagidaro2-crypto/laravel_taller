...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8 flex items-center gap-4">
        <a href="{{ route('cliente.historial.index') }}" class="text-orange-500 hover:text-orange-600 font-semibold flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow p-8">
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <p class="text-sm text-slate-600 uppercase tracking-wide font-semibold mb-2">Duracion</p>
                        @if($historialVehiculo->fecha_fin)
                            <p class="text-slate-900 font-semibold">
                                {{ $historialVehiculo->fecha->diffInMinutes($historialVehiculo->fecha_fin) }} minutos
                            </p>
                        @else
                            <p class="text-slate-600">No finalizado</p>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            @if($historialVehiculo->usuario->telefono)
                                <p class="text-slate-600 text-sm">{{ $historialVehiculo->usuario->telefono }}</p>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            @if($historialVehiculo->vehiculo)
                <div class="bg-white rounded-xl shadow p-8">
                    <h3 class="text-xl font-bold text-slate-900 mb-6">Estado del Vehículo al Servicio</h3>
        ...
        <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow p-6 sticky top-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-900 font-semibold">{{ $historialVehiculo->vehiculo->color }}</p>
                        </div>

                        <a href="{{ route('cliente.vehiculos.show', $historialVehiculo->vehiculo) }}" class="block text-center mt-4 text-orange-500 hover:text-orange-600 font-semibold transition text-sm">
            ...
            <div class="bg-white rounded-xl shadow p-6">
                ...
                <a href="{{ route('cliente.historial.index') }}" class="block text-center bg-slate-300 text-slate-900 px-4 py-2.5 rounded-lg hover:bg-slate-400 font-semibold transition">
                    Volver al Historial
                </a>
            </div>
        </div>
