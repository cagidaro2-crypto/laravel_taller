...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-slate-900">Registrar Nuevo Vehículo</h1>
        <p class="text-slate-600 mt-2">Completa los datos de tu vehículo</p>
    </div>

    <div class="bg-white rounded-xl shadow p-6">
        <form action="{{ route('cliente.vehiculos.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="Sedán" {{ old('tipo') === 'Sedán' ? 'selected' : '' }}>Sedán</option>
